...
import { Grid, Box, Typography, Chip, Button, Paper } from '@mui/material'
  ...
  return (
    <Fade direction='up' triggerOnce={true}>
      ...
      >
        ...
        <Grid container sx={{ marginTop: "70px" }} display={"flex"} justifyContent={"center"} alignItems={"center"} gap={0} spacing={2}>
          {/* Chip */}
          ...
          <Grid item xs={11} md={8} marginTop={0} display={"flex"} justifyContent={"center"} alignItems={"center"}>
            <Typography margin={0} maxWidth={"50rem"} lineHeight={1} textAlign="center" variant="h1" fontSize={"3.2rem"} fontWeight="800" sx={{ marginTop: '0px', color: 'whitesmoke' }}>
              Crafting{' '}
          ...
          {/* Slider */}
          <Grid marginTop={5} item xs={11} maxWidth="50rem" display={"flex"} justifyContent={"center"} alignItems={"center"}>
            <Box sx={{ width: "50rem" }}>
              <Slider {...settings}>
                {[
                  "React",
